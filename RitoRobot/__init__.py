...
if ENV:
    ...
    from RitoRobot.config import Development as Config
...
telethn = TelegramClient("Rito", API_ID, API_HASH)

pbot = Client("RitoRobot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
